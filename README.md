...
The approach is to fit from the observations a time-invariant filter which reproduces the vector of observations with a small error, and at the same time has a small l1-norm in the DFT domain. This is done by solving an appropriate convex optimization problem.
